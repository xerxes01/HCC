...
kite.login_url()
data = kite.generate_session(request_token = 'z9SiocFIZmvSR2oG4v7ibky8JW0y1RM7', api_secret=api_secret)
...
class HistoricalData(object):
    ...
    def get_max_data(self, interval='minute'):
        tick_data = []
        start_date = pd.to_datetime('01/01/2001', dayfirst=True, format='%d/%m/%Y')
